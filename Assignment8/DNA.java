...
public class DNA {
    ...
    public void createDatabaseOfProfiles ( String filename ) {
        ...
        database = new Profile[numberOfLines];
        ...
        for(int i = 0; i < numberOfLines;i++)
        {
            ...
            Profile tempProfile = new Profile(name, null, null, seq1, seq2);
            database[i] = tempProfile;
        }
    ...
    public void readSTRsOfInterest ( String filename ) {
        ...
        STRsOfInterest = new String[numberOfLines];
	...
	StdIn.setFile(filename); // DO NOT remove this line, keep as the first line in the method.
        ...
        String sec1 = StdIn.readLine();
        String sec2 = StdIn.readLine();

        Profile Unknown = new Profile("Unknown", null, null, sec1, sec2);
    ...
    public STR findSTRInSequence ( String sequence, String STR ) {
        ...
        for(int i = 0; i < sequence.length(); i++) {
            if (sequence.startsWith(STR, i)) {
                ...
                if (consecRepeat > maxRepeats) {
                    maxRepeats = consecRepeat;
            }
            consecRepeat = 0;
            }
        }
    ...
    public void createProfileSTRs ( Profile profile, String[] allSTRs ) {
        ...
        String sec1 = profile.getSequence1();
        String sec2 = profile.getSequence2();
        ...
        for(int i = 0; i < allSTRs.length; i++) 
        {
           ...
           STR s1 = findSTRInSequence(sec1, STR);
           STR s2 = findSTRInSequence(sec2, STR);
    ...
    public ArrayList<Profile> findMatchingProfiles ( STR[] unknownProfileS1_STRs ) {
        ...
        for(int i = 0; i < database.length; i++)
        {
            ...
            STR[] compareList1 = database[i].getS1_STRs();

            if((identicalSTRs(compareList1, unknownProfileS1_STRs)))
            {
	...
	return matches; // update the return value
    }
    ...
    public ArrayList<Profile> findPossibleParents ( STR[] S1_STRs, STR[] S2_STRs ) {
        ...
        ArrayList<Profile> parentList = new ArrayList<>(); //possibleparent2 is always called first
